...
public class ShortPollWorkerExample_TaskModelFactory {

    public static TaskModel from(org.kie.kogito.process.WorkItem workItem) {
        switch(workItem.getNodeId().toExternalFormat()) {
            case "_SPW_FetchAndLockTask":
                return ShortPollWorkerExample__SPW_FetchAndLockTask_TaskModel.from(workItem);
            default:
